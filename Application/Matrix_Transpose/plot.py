...
df=pd.read_csv("non_block_4n_8ppn.txt",names=['Y'])
temp4=np.array(df['Y'])
df=pd.read_csv("non_block_8n_8ppn.txt",names=['Y'])
temp5=np.array(df['Y'])
df=pd.read_csv("non_block_16n_8ppn.txt",names=['Y'])
temp6=np.array(df['Y'])
...
df=pd.read_csv("non_block_4n_32ppn.txt",names=['Y'])
temp10=np.array(df['Y'])
df=pd.read_csv("non_block_8n_32ppn.txt",names=['Y'])
temp11=np.array(df['Y'])
df=pd.read_csv("non_block_16n_32ppn.txt",names=['Y'])
...
def plot_fcn_8ppn():
    ...
    plt.errorbar(label_x, x1,yerr=y1,fmt='-o',label="default Matrix Transpose",linewidth=3,color = 'red',linestyle='solid',ecolor='r',capsize=3,marker="o",markersize=10)
    plt.errorbar(label_x, x2,yerr=y2,fmt='-o',label="Matrix Transpose with FFTOpt",linewidth=3,color = 'blue',linestyle='solid',ecolor='b',capsize=3,marker="^",markersize=10)
    plt.ylim(bottom=0) 
    plt.xlim(left=0)
    ...
    plt.legend()
    plt.savefig("matrix_transpose_8ppn.jpg")
...
def plot_fcn_32ppn():
    ...
    plt.yticks(fontsize=36)
    plt.errorbar(label_x, x3,yerr=y3,fmt='-o',label="default Matrix Transpose",linewidth=3,color = 'red',linestyle='solid',ecolor='r',capsize=3,marker="o",markersize=10)
    plt.errorbar(label_x, x4,yerr=y4,fmt='-o',label="Matrix Transpose with FFTOpt",linewidth=3,color = 'blue',linestyle='solid',ecolor='b',capsize=3,marker="^",markersize=10)
    plt.ylim(bottom=0) 
    plt.xlim(left=0)
    ...
    plt.title("Time vs Number of nodes",fontsize=38)
    plt.legend()
    plt.savefig("matrix_transpose_32ppn.jpg")
