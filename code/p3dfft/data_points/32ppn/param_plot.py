...
def plot_fcn():
    ...
    plt.errorbar(label_x, x1,yerr=y1,fmt='-o',label="1024^3 grid (default P3DFFT)",linewidth=3,color = 'red',linestyle='solid',ecolor='r',capsize=3)
    plt.errorbar(label_x, x2,yerr=y2,fmt='-o',label="1024^3 grid (1-leader case with Isend/Irecv P3DFFT)",linewidth=3,color = 'darkorange',linestyle='solid',ecolor='darkorange',capsize=3)
    plt.errorbar(label_x, x3,yerr=y3,fmt='-o',label="1024^3 grid (2-leader case with Isend/Irecv P3DFFT)",linewidth=3,color = 'blue',linestyle='solid',ecolor='blue',capsize=3)
    plt.errorbar(label_x, x4,yerr=y4,fmt='-o',label="1024^3 grid (4-leader case with Isend/Irecv P3DFFT)",linewidth=3,color = 'magenta',linestyle='solid',ecolor='magenta',capsize=3)
    plt.errorbar(label_x, x5,yerr=y5,fmt='-o',label="1024^3 grid (8-leader case with Isend/Irecv P3DFFT)",linewidth=3,color = 'green',linestyle='solid',ecolor='green',capsize=3)
    plt.errorbar(label_x, x6,yerr=y6,fmt='-o',label="1024^3 grid (1-leader case with RMA P3DFFT)",linewidth=3,color = 'olive',linestyle='solid',ecolor='olive',capsize=3)
    plt.errorbar(label_x, x7,yerr=y7,fmt='-o',label="1024^3 grid (2-leader case with RMA P3DFFT)",linewidth=3,color = 'cyan',linestyle='solid',ecolor='cyan',capsize=3)
    plt.errorbar(label_x, x8,yerr=y8,fmt='-o',label="1024^3 grid (4-leader case with RMA P3DFFT)",linewidth=3,color = 'lime',linestyle='solid',ecolor='lime',capsize=3)
    plt.errorbar(label_x, x9,yerr=y9,fmt='-o',label="1024^3 grid (8-leader case with RMA P3DFFT)",linewidth=3,color = 'gray',linestyle='solid',ecolor='gray',capsize=3)
    plt.ylim(bottom=0) 
    plt.xlim(left=0)
    ...
    plt.legend()
    plt.savefig("isend_vs_rma_32ppn_p3dfft.jpg")
